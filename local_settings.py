...
MY_CONSUMER_KEY = environ.get('qMYdXVqFaVoONGNQaUFZo687e')#Your Twitter API Consumer Key set in Heroku config
MY_CONSUMER_SECRET = environ.get('VhgfPMJr0Tp66AAqIkpcbBvkKgA3WzsLBVNA5E1wYFsQ16WPda')#Your Consumer Secret Key set in Heroku config
MY_ACCESS_TOKEN_KEY = environ.get('1303410070223556608-XfdR1rDaZNtUllWyCrm1fvDFu7i9wj')#Your Twitter API Access Token Key set in Heroku config
MY_ACCESS_TOKEN_SECRET = environ.get('PaB5FuvL3XRDTnZlXONTiK6AGDjmEb8k69QZJfx0ZxHAa')#Your Access Token Secret set in Heroku config
...
TWITTER_SOURCE_ACCOUNTS = ["ps3hasnogame"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "ps3hasnogame2"  # The name of the account you're tweeting to.
